...
#
echo "下载openclash141"
wget https://github.com/vernesong/OpenClash/releases/download/v0.45.152-beta/luci-app-openclash_0.45.152-beta_all.ipk -O luci-app-openclash_0.45.141-beta_all.ipk
